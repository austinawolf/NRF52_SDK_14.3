...
ReturnType FlashDataRead(uAddrType udAddr, uint8 *ucpElements, uint32 udNrOfElementsToRead, InstructionType insInstruction);
...
ReturnType FlashPermanentProtectionBitErase(void);
