...
/* Define to 1 if you want to implement Spinel vendor command support */
#define OPENTHREAD_ENABLE_SPINEL_VENDOR_SUPPORT 0

/* Define to 1 to enable the TMF proxy feature. */
#define OPENTHREAD_ENABLE_TMF_PROXY 1

/* OpenThread examples */
#define OPENTHREAD_EXAMPLES nrf52840
...
#define PACKAGE_STRING "OPENTHREAD ga89eb88-dirty"
...
#define PACKAGE_VERSION "ga89eb88-dirty"

/* Define to 1 if you have the ANSI C header files. */
#define STDC_HEADERS 1

/* Version number of package */
#define VERSION "ga89eb88-dirty"
